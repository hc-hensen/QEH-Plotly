...
''' seems pandas too big, use json as replacement. 
requirement.txt also need to update '''
...
''' many code in below func are only print for checking '''
...
def pivot_table_no_pandas(chart_list, kpi_v):
    ...
    ''' get heatmap yaxis & xaxis value by printing another list '''
